import { Response } from "../../../../sharedResources/TSInterfaces/APIRequest";
import { GameState, Move, PieceType } from "../../../../sharedResources/TSInterfaces/boardData";
...
const sendMove = (
    state: GameState, move: Move, promotionTarget: PieceType | null,
    callback: (state: GameState) => void)
    : void => {
