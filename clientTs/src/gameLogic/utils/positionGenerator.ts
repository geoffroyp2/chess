import { BoardState, Piece, PieceType } from '../../../../sharedResources/TSInterfaces/boardData';
...
export default function generatePosition(mode: string): BoardState {
    ...
    if (mode === "DEFAULT") {
        ...
        for (let i = 0; i < 8; i++)
            position.Pieces.push(createPiece(PieceType.Pawn, true, i, 6));
        ...
        for (let i = 0; i < 8; i++)
            position.Pieces.push(createPiece(PieceType.Pawn, false, i, 1));
    }
